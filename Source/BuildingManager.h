...
public:
	...
	Building &		    addTrackedBuildingTask(const MacroAct & act, BWAPI::TilePosition desiredLocation, BuildOrderItem & item);
	void                addBuildingTask(const MacroAct & act, BWAPI::TilePosition desiredLocation, BuildOrderItem & item);
	...
	int					numBeingBuilt(BWAPI::UnitType hatchery);
	bool				isBuildingMacroHatchery();
